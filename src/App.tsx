        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex justify-start items-center">
              <span className="text-xl sm:text-2xl font-italic text-[#ffffff] rounded-md px-2 sm:px-4 py-2 scale-105 [text-shadow:_-1px_-1px_0_#FF4500,_1px_-1px_0_#FF4500,_-1px_1px_0_#FF4500,_1px_1px_0_#FF4500]">TechStore</span>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ffffff" className="w-6 h-6 sm:w-8 sm:h-8 -ml-1 [filter:drop-shadow(-1px_-1px_0_#FF4500)_drop-shadow(1px_-1px_0_#FF4500)_drop-shadow(-1px_1px_0_#FF4500)_drop-shadow(1px_1px_0_#FF4500)]">
