        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex justify-start items-center">
              <span className="text-xl sm:text-2xl font-italic text-[#FF4500] rounded-md px-2 sm:px-4 py-2 scale-105 ">TechStore</span>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#FF4500" className="w-6 h-6 sm:w-8 sm:h-8 -ml-1 ">
